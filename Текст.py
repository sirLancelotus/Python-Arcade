...
open_window(260,55,"Text")
set_background_color(color=(0,0,0))

start_render()

#Оказывается, удобнее прописывать расположение файла с этим шрифтом в папке Windows на компе, чем писать его название вручную
...
draw_text('''My small text :D''',10,10,color=(255,255,255),font_size=24,font_name='C:/Windows/Fonts/VINERITC')
